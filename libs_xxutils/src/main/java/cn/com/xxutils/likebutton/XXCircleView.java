...
public class XXCircleView extends View {
    ...
    private void updateCircleColor() {
        float colorProgress = (float) XXUtils.clamp(outerCircleRadiusProgress, 0.5, 1);
        colorProgress = (float) XXUtils.mapValueFromRangeToRange(colorProgress, 0.5f, 1f, 0f, 1f);
