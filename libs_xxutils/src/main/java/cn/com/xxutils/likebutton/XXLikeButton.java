...
public class XXLikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private XXDotsView XXDotsView;
    private XXCircleView XXCircleView;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        XXDotsView = (XXDotsView) findViewById(R.id.dots);
        XXCircleView = (XXCircleView) findViewById(R.id.circle);
    ...
    public void setLikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            likeDrawable = XXUtils.resizeDrawable(getContext(), likeDrawable, iconSize, iconSize);
        }
    }
    ...
    public void setLikeDrawable(Drawable likeDrawable) {
        ...
        if (iconSize != 0) {
            this.likeDrawable = XXUtils.resizeDrawable(getContext(), likeDrawable, iconSize, iconSize);
        }
    ...
    public void setUnlikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            unLikeDrawable = XXUtils.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconSize);
        }
    ...
    public void setUnlikeDrawable(Drawable unLikeDrawable) {
        ...
        if (iconSize != 0) {
            this.unLikeDrawable = XXUtils.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconSize);
        }
        icon.setImageDrawable(unLikeDrawable);
    ...
    {
        setIconSizePx((int) XXUtils.dipToPixels(getContext(), (float) iconSize));
    }
    /**
     * Sets the size of the drawable/icon that's being used. The views that generate
     * the like effect are also updated to reflect the size of the icon.
    ...
    private Icon parseIconType(String iconType) {
        List<Icon> icons = XXUtils.getIcons();
